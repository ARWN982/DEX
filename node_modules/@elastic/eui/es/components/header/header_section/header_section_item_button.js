...
ref) {
  ...
  var styles = useEuiMemoizedStyles(euiHeaderSectionItemButtonStyles);
  var classes = classNames('euiHeaderSectionItemButton', className);
  var isSmallScreen = useIsWithinMaxBreakpoint('s');
  var shouldShowDot = notification === true || !!(notification && isSmallScreen);
  var buttonNotification = useMemo(function () {
    ...
    if (shouldShowDot) {
      ...
      return ___EmotionJSX(EuiNotificationBadge, {
