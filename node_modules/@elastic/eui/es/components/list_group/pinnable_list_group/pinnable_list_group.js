...
export var EuiPinnableListGroup = function EuiPinnableListGroup(_ref) {
  ...
  var styles = useEuiMemoizedStyles(euiPinnableListGroupItemExtraActionStyles);
  var pinExtraActionLabel = useEuiI18n('euiPinnableListGroup.pinExtraActionLabel', 'Pin item');
  var pinnedExtraActionLabel = useEuiI18n('euiPinnableListGroup.pinnedExtraActionLabel', 'Unpin item');

  // Alter listItems object with extra props
  var pinnableListItems = useMemo(function () {
