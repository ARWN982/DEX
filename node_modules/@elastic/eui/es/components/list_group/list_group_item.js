...
export var EuiListGroupItem = function EuiListGroupItem(_ref) {
  ...
  var iconStyles = useEuiMemoizedStyles(euiListGroupItemIconStyles);
  ...
  var itemContent;
  var innerStyles = useEuiMemoizedStyles(euiListGroupItemInnerStyles);
  ...
  return ___EmotionJSX(React.Fragment, null, itemContent);
};
