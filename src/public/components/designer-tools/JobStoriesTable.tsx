...
export const JobStoriesTable: React.FC<JobStoriesTableProps> = ({
  stories,
  onStoriesChange,
}) => {
  const { colorMode } = useAppStore();
  const designColors = getDesignUIColors(colorMode);
  ...
  const updateStory = (id: string, field: keyof JobStory, value: string) => {
  ...
  // Define columns
  const columns: EuiBasicTableColumn<JobStory>[] = [
    {
      field: "jobStory",
      name: "Job Stories",
      render: (value: string, story: JobStory) => {
        return (
          <div
            contentEditable
            ...
            data-placeholder={value ? "" : "Enter job story"}
          >
            {value}
          </div>
        );
      ...
      render: (value: string, story: JobStory) => {
        return (
          <div
            ...
            data-placeholder={value ? "" : "Enter acceptance criteria"}
          >
            {value}
          </div>
        );
    ...
    },
    {
      ...
      name: "Covered?",
      render: (value: "Not yet" | "Yes", story: JobStory) => {
        const options = [
          {
            value: "Not yet",
