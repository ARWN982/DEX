...
export const SimpleESQL: React.FC = () => {
  ...
  const [showVisorBar, setShowVisorBar] = useState(true);
  ...
  const parseKQLComment = (query: string): { dataSource: string; searchTerm: string } | null => {
    ...
    <div style={{ display: "flex", width: "100%", height: "100vh" }}>
      ...
      >
        <div style={{ gridColumn: "1", gridRow: "1" }}>
          {/* AI Prompt Bar - shown by default, hidden when user edits generated code */}
          {showVisorBar && (
            <VisorFixedBar 
